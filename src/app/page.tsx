          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <h1 className=" text-4xl font-bold tracking-tight text-white sm:text-6xl">
                ...
                Never lose track of your beloved pet again with our advanced pet locator technology. Whether they have wandered off or simply playing hide-and-seek, our system ensures a quick and reliable way to bring them home safely.
                </p>
